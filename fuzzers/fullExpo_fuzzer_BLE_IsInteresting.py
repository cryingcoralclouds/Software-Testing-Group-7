    ...
    def pilot_fuzz(self, crash_dir):
        ...
        for swarm in self.swarms:
            for _ in range(self.core_fuzz_num):
                ...
                runs += 1
                energy = assign_energy(seedObject, all_found_paths)
...
def is_interesting(
    ...
    """
    # =================================== For django isinteresting ===================================
    if seen_combinations is None and response_codes_seen is None: # since django checks interesting via coverage only 
        return track_execution_path()
    # =================================== For django isinteresting ===================================
